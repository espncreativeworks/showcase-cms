...
Execution.add({
  ...
  images: { type: Types.Relationship, ref: 'Image', filters: { usage: 'execution', platform: ':platform' }, many: true, collapse: true },
  videos: { type: Types.Relationship, ref: 'Video', filters: { usage: 'execution', platform: ':platform' }, many: true, collapse: true },
